...
<body>
    <section class="A">
        ...
        <div class="form">
            ...
            <p>
            <div class="f2">
                <h1 style="color: white; font-weight: 600; font-size: 50px;">Instructors Messages</h1>
            </div>
            <div class="f3">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{route('adminDestroyInstructorMessages.destroy',$message['message_id'])}}"
                            method="POST">
                            @csrf
                            @method('DELETE')
