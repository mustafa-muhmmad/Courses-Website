...
<body>
    ...
    <div class="register">
        <div class="text">
            ...
            <p>Get access to exclusive content and updates by signing up today</p>
        </div>

        <div class="signup">
            <a class="icon" href="{{ route('studentregister-page') }}"><i class="fa-solid fa-arrow-pointer"></i></a>

            <a class="s" href="{{ route('studentregister-page') }}">Sign up</a>
        </div>
        <br />
        <br />
        <br />
